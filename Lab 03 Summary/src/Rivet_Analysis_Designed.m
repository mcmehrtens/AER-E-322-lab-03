...
e = 1/2;            % [in] -- distance of rivet center from the edge
layout = [4, 4];    % [] -- rivets in each row counting from the loaded row
N = sum(layout);    % []
N_e = layout(2);    % []
...
fprintf(['F_s  = %6.4g [lb]\n' ...
         ...
         '\x03C3_t1 = %6.4g [ksi]\n' ...
         '\x03C3_t2 = %6.4g [ksi]\n'], ...
         F_s, F_b, F_to, F_t1, F_t2, ...
         sigma_t1 / 1000, sigma_t2 / 1000);